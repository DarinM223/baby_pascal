...
let test_example_1 () =
  ...
  let expected =
    ...
    @@ branch (1, "label1")
    @@ label (4, "label4")
    @@ cbranch [ name "a" ] EQ ~ifso:(6, "label6") ~ifnot:(1, "label1")
    @@ label (5, "label5")
    @@ instruction
    ...
    @@ branch (4, "label4")
    @@ label (6, "label6")
    @@ cbranch [ name "a" ] LT ~ifso:(5, "label5") ~ifnot:(1, "label1")
    @@ label (7, "label7")
    @@ cbranch [ name "a" ] LT ~ifso:(2, "label2") ~ifnot:(3, "label3")
    @@ label (8, "label8")
    @@ cbranch [ name "a" ] EQ ~ifso:(7, "label7") ~ifnot:(3, "label3")
    @@ focus_entry empty
  in
